...
export default function Landing () {
  ...
  let ctx = gsap.context( () => { 
    ...
    <img className="bottom-img" src="https://images.unsplash.com/photo-1542576329-818ff4ffda3f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NTJ8fHRvdXJpc3QlMjBjaXR5fGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60" />
     </div>
      );
    }
